...
#Add 2018
if 2018 not in datafiles['WNCAATourneySeeds_SampleTourney2018']['Season'].unique():
...
#Test Set
sub = datafiles['WSampleSubmissionStage2']
sub['WLoc'] = 3 #N
...
sub[['ID','Pred']].to_csv('etr_sub.csv', index=False)